...
public class CreatePeriodInfo {
    ...
    public CreatePeriodInfo(long id, LocalDate startDate, BigDecimal startColdWater,
                            BigDecimal startHotWater, BigDecimal startElectricity,
                            LocalDate endDate, BigDecimal endColdWater,
                            BigDecimal endHotWater, BigDecimal endElectricity, List<Long> renters) {
        this.id = id;
